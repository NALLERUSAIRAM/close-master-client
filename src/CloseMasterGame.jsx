        ...
        {started && (
          <div className="z-10 w-full max-w-5xl grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-4">
            {players.map((p) => {
             ...
             if (isYou && isTurn) {
  playerClasses.push("border-fuchsia-400 bg-black/70 shadow-[0_0_25px_rgba(236,72,153,1)] scale-105 z-20");
}
  ...
  >
    ...
    <div className="flex items-center justify-between px-1 mb-1">
      ...
      <button
        ...
        className="text-xs px-1.5 py-0.5 rounded-full bg-black/40 border border-white/40"
      >
        🎭
      </button>
      ...
      {/* RIGHT – TIMER */}
      {isTurn && (
        <div className="w-7 h-7 rounded-full border-2 flex items-center justify-center text-xs font-black border-red-400 text-red-200 shadow-[0_0_8px_rgba(248,113,113,0.9)]">
          {turnTimeLeft}
        </div>
      )}
    </div>
